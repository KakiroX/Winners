    ...
    <header className="fixed top-0 left-0 right-0 z-[200] bg-white/80 backdrop-blur-md border-b border-slate-100 h-20">
      <div className="max-w-7xl mx-auto px-6 h-full flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8 text-sm font-bold text-slate-500 uppercase tracking-wider">
           ...
           <Link href="/plan" className="hover:text-slate-900 transition-colors">Interior Design</Link>
        ...
        <div className="flex items-center gap-3">
          {user ? (
            <div className="flex items-center gap-4">
              ...
              <button onClick={logout} className="w-10 h-10 bg-slate-100 text-slate-500 rounded-full flex items-center justify-center hover:bg-slate-200 transition-all">
