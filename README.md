...
-    User then can change interior design in the panorama itself and Dehabit will apply edits, changing the room. 
## BOM
-    After completing the design, user can view prices and links to buy included furniture in BOM function, generated using visual intellegence model and web-search model
-    There is a batch BOM if user has multiple projects and designs
